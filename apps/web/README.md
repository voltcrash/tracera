...
production build mode, and refuses to start unless this worktree's PostgreSQL
container is healthy. Do not run the workspace command directly or create a
root `.env`; see `docs/environment.md`.
