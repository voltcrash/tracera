...
2. Start Expo from the repository root: `pnpm dev:mobile`.
3. Scan the QR code with Expo Go. To use the faster LAN-only Metro connection, run `pnpm --filter mobile start:lan` instead.
