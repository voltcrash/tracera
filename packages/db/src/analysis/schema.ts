...
export const analysisJobs = pgTable(
  "core_jobs",
  {
    ...
    runId: text("run_id")
      .notNull()
      .references(() => analysisRuns.runId, { onDelete: "cascade" }),
    ...ownershipColumns(),
...
export const analysisStageCheckpoints = pgTable(
...
export const analysisSnapshotEmbeddings = pgTable(
  ...
  (table) => [
    ...
    foreignKey({
      columns: [table.tenantId, table.ownerUserId, table.visibility, table.snapshotId],
      foreignColumns: [
        analysisSnapshots.tenantId,
        analysisSnapshots.ownerUserId,
        analysisSnapshots.visibility,
        analysisSnapshots.snapshotId,
      ],
...
export const analysisReportVersions = pgTable(
  "core_report_versions",
  {
    runId: text("run_id")
      .notNull()
      .references(() => analysisRuns.runId, { onDelete: "restrict" }),
...
export const analysisReportClaims = pgTable(
  "core_report_claims",
  {
...
export const analysisReportSnapshots = pgTable(
...
export const analysisEvidenceAssessments = pgTable(
...
export const analysisProvenanceEdges = pgTable(
...
export const analysisDecisions = pgTable(
  "core_decisions",
  {
    runId: text("run_id").notNull(),
    reportVersion: integer("report_version").notNull(),
...
export const analysisOutbox = pgTable(
  "core_outbox",
  {
