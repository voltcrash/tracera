...
-- Rate limits, leases, quotas, and spend accounting are read-modify-write from
-- the application role on every analysis request.
GRANT SELECT, INSERT, UPDATE
  ON TABLE public.analysis_rate_limits,
           public.analysis_leases,
           public.analysis_idempotency_keys,
           public.analysis_daily_quotas,
           public.analysis_force_cooldowns,
           public.ai_provider_spend,
