import type { SufficiencyFeedback } from "@repo/contracts/analysis";
...
export function createProvenanceRetrievalController(
  retrievalOptions: Parameters<typeof createRetrieveEvidence>[0] = {},
  ...
  return {
    async retrieveReference(request, environment) {
      ...
      const retrieve = createRetrieveEvidence({
        ...retrievalOptions,
