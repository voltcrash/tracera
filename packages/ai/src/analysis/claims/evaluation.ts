import { ANALYSIS_CONTRACT_VERSION, type Claim, type Span } from "@repo/contracts/analysis";
...
import type { ExtractClaims, RunEnvironment } from "../types";
...
export function createClaimExtractionAdapter(
  ...
  const extract = adapterOptions.extract ?? extractClaims;
  return {
